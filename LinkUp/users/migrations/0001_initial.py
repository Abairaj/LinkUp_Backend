# Generated by Django 4.1.8 on 2023-05-25 11:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facebook_uid', models.CharField(blank=True, max_length=500)),
                ('profile', models.ImageField(blank=True, null=True, upload_to='profile')),
                ('gender', models.CharField(blank=True, choices=[('Female', 'Female'), ('Male', 'Male'), ('Transgenders', 'Transgenders')], max_length=30)),
